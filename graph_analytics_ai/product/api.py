...
PRODUCT_API_ENDPOINTS = [
    ...
    ProductAPIEndpoint(
        method="POST",
        path="/api/workspaces/{workspace_id}/use-cases",
        service_method="create_use_case",
        summary="Create a use case",
        tags=["use-cases"],
        request_model="CreateUseCaseRequest",
        response_model="UseCase",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/workspaces/{workspace_id}/use-cases",
        service_method="list_use_cases",
        summary="List use cases for a workspace",
        tags=["use-cases"],
        response_model="List[UseCase]",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/use-cases/{use_case_id}",
        service_method="get_use_case",
    ...
    ProductAPIEndpoint(
        method="PATCH",
        path="/api/use-cases/{use_case_id}",
        service_method="update_use_case",
        summary="Edit a draft use case",
        tags=["use-cases"],
        request_model="UpdateUseCaseRequest",
        response_model="UseCase",
    ),
    ProductAPIEndpoint(
        method="POST",
        path="/api/use-cases/{use_case_id}/status",
        service_method="set_use_case_status",
        summary="Approve, reject, or archive a use case",
        tags=["use-cases"],
        request_model="SetUseCaseStatusRequest",
        response_model="UseCase",
    ),
    ProductAPIEndpoint(
        method="POST",
        path="/api/use-cases/{use_case_id}/priority",
        service_method="set_use_case_priority",
        summary="Re-prioritise a use case",
        tags=["use-cases"],
        request_model="SetUseCasePriorityRequest",
        response_model="UseCase",
    ),
    # FR-22..FR-26. Templates are versioned: editing an approved template
    # supersedes it rather than mutating it, so completed runs still resolve
    # the exact row they executed.
    ProductAPIEndpoint(
        method="POST",
        path="/api/workspaces/{workspace_id}/analysis-templates",
        service_method="create_analysis_template",
        summary="Create a draft analysis template",
        tags=["analysis-templates"],
        request_model="CreateAnalysisTemplateRequest",
        response_model="AnalysisTemplate",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/workspaces/{workspace_id}/analysis-templates",
        service_method="list_analysis_templates",
        summary="List analysis templates for a workspace",
        tags=["analysis-templates"],
        response_model="List[AnalysisTemplate]",
    ),
    ProductAPIEndpoint(
        method="POST",
        path="/api/workspaces/{workspace_id}/analysis-templates/import",
        service_method="import_analysis_templates",
        summary="Import template dictionaries without executing code",
        tags=["analysis-templates"],
    ...
    ProductAPIEndpoint(
        ...
        service_method="get_analysis_template",
        summary="Get an analysis template",
        tags=["analysis-templates"],
        response_model="AnalysisTemplate",
    ),
    ProductAPIEndpoint(
        method="PATCH",
        path="/api/analysis-templates/{analysis_template_id}",
        service_method="update_analysis_template",
        summary="Edit algorithm parameters; versions an approved template",
        tags=["analysis-templates"],
        request_model="UpdateAnalysisTemplateRequest",
        response_model="AnalysisTemplate",
    ),
    ProductAPIEndpoint(
        method="POST",
        path="/api/analysis-templates/{analysis_template_id}/approve",
        service_method="approve_analysis_template",
        summary="Approve a draft template, making it immutable",
        tags=["analysis-templates"],
        response_model="AnalysisTemplate",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/analysis-templates/{analysis_template_id}/versions",
        service_method="get_analysis_template_versions",
        summary="List every version in a template's lineage",
        tags=["analysis-templates"],
        response_model="List[AnalysisTemplate]",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/workspaces/{workspace_id}/analysis-catalog",
        service_method="browse_analysis_catalog",
        summary="Browse workspace analysis epochs, executions, and lineage references",
        tags=["analysis-catalog"],
        response_model="AnalysisCatalogView",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/workspaces/{workspace_id}/analysis-executions",
        service_method="list_analysis_executions",
        summary="Search workspace analysis executions",
        tags=["analysis-catalog"],
        response_model="AnalysisExecutionList",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/analysis-executions/{analysis_execution_id}",
        service_method="get_analysis_execution",
    ...
    ProductAPIEndpoint(
        method="GET",
        path="/api/analysis-executions/{analysis_execution_id}/lineage",
        service_method="get_analysis_lineage",
        summary="Trace report-to-requirement lineage for an execution",
        tags=["analysis-catalog"],
        response_model="AnalysisLineageView",
    ),
    ProductAPIEndpoint(
        method="POST",
        path="/api/workspaces/{workspace_id}/analysis-executions/compare",
        service_method="compare_analysis_executions",
        summary="Compare executions across analysis epochs",
        tags=["analysis-catalog"],
        request_model="CompareAnalysisExecutionsRequest",
        response_model="AnalysisExecutionComparison",
    ),
    ProductAPIEndpoint(
        method="POST",
        path="/api/workspaces/{workspace_id}/analysis-epochs",
        service_method="create_analysis_epoch",
        summary="Create an analysis epoch",
        tags=["analysis-catalog"],
        request_model="CreateAnalysisEpochRequest",
        response_model="AnalysisEpoch",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/workspaces/{workspace_id}/analysis-epochs",
        service_method="list_analysis_epochs",
        summary="List analysis epochs",
        tags=["analysis-catalog"],
        response_model="AnalysisEpochList",
    ),
    ProductAPIEndpoint(
        method="GET",
        path="/api/analysis-epochs/{analysis_epoch_id}",
        service_method="get_analysis_epoch",
        summary="Get an analysis epoch",
        tags=["analysis-catalog"],
        response_model="AnalysisEpoch",
    ),
    ProductAPIEndpoint(
        ...
        tags=["analysis-catalog"],
        response_model="AnalysisCatalogStats",
    ),
    ProductAPIEndpoint(
        method="GET",
