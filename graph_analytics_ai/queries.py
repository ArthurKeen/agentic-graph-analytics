...
def cross_reference_results(
    ...
    Args:
        ...
        filter2: Optional AQL filter expression for collection2 (e.g., "w.component_id == 'persons/xxx'")
    ...
    Example:
        ...
        results = cross_reference_results(
            ...
            filter2="w.component_id == 'persons/00Hj-5Cag'",
            limit=100
        )
    """
...
def get_top_influential_connected(
    ...
    if include_vertex_details:
        if vertex_fields is None:
            vertex_fields = ['NameEx.GdValue.FullName', 'PrimarySpecialties', 'Emails']
...
def get_results_with_details(
    ...
    Args:
        ...
        vertex_collection: Vertex collection name (e.g., 'persons')
    ...
    Example:
        ...
        results = get_results_with_details(
            db,
            'pagerank_results',
            fields=['NameEx.GdValue.FullName', 'PrimarySpecialties'],
            result_filter='r.pagerank_influence >= 0.000002',
            limit=100
        )
    """
    if fields is None:
        fields = ['NameEx.GdValue.FullName', 'PrimarySpecialties', 'Emails']
