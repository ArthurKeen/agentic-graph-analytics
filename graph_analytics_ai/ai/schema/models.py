...
class GraphSchema:
    ...
    def get_relationships_for_collection(self, collection_name: str) -> List[Relationship]:
        """Get all relationships involving a specific collection."""
        return [
            rel for rel in self.relationships
            if (rel.from_collection == collection_name or 
                rel.to_collection == collection_name)
        ]
        ...
        return {
            ...
            "vertex_collections": {
                name: {
                    ...
                    "sample_document": col.sample_documents[0] if col.sample_documents else None
                }
