...
class TestVerifyResultCollection:
    ...
    def test_verify_valid_collection(self):
        ...
        sample_doc = {'id': 'persons/123', 'pagerank_influence': 0.5}
...
class TestValidateResultSchema:
    ...
    def test_validate_valid_schema(self):
        ...
        sample_docs = [
            {'id': 'persons/123', 'pagerank_influence': 0.5}
        ]
    ...
    def test_validate_type_mismatch(self):
        ...
        sample_docs = [{'id': 'persons/123', 'pagerank_influence': '0.5'}]
        mock_db.aql.execute.return_value = sample_docs
...
class TestBulkUpdateResultMetadata:
    ...
    def test_bulk_update_success(self):
        ...
        mock_doc1 = {'_key': 'key1', 'id': 'persons/1'}
        mock_doc2 = {'_key': 'key2', 'id': 'persons/2'}
