...
from graph_analytics_ai.export import (
...
class TestExportResultsToCSV:
    ...
    def test_export_csv_success(self):
        ...
        # Mock query results
        mock_results = [
            {'id': 'persons/1', 'pagerank_influence': 0.5},
            {'id': 'persons/2', 'pagerank_influence': 0.3}
        ]
    ...
    def test_export_csv_no_headers(self):
        ...
        mock_db = MagicMock()
        mock_results = [{'id': 'persons/1', 'value': 0.5}]
        mock_db.aql.execute.return_value = mock_results
    ...
    def test_export_csv_write_error(self):
        ...
        mock_db = MagicMock()
        mock_db.aql.execute.return_value = [{'id': 'persons/1'}]
