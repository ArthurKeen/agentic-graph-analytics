...
class TestSchemaAnalyzer:
    ...
    def test_analyze_success(self, sample_graph_schema, mock_llm_provider):
        ...
        assert analysis.description == "A social network graph with users and their relationships."
    ...
    def test_analyze_llm_failure(self, sample_graph_schema, mock_llm_provider):
        ...
        # Make LLM fail
        mock_llm_provider.generate_structured.side_effect = LLMProviderError("LLM failed")
