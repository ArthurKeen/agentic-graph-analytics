...
class TestUseCaseGenerator:
    ...
    def test_generate_with_schema_analysis(
        ...
        analysis = SchemaAnalysis(
            ...
            suggested_analyses=[
                {"type": "pagerank", "title": "PageRank", "reason": "Find influential users"},
                {"type": "community_detection", "title": "Communities", "reason": "Find clusters"}
            ],
            complexity_score=4.0,
        )
        
        gen = UseCaseGenerator(max_use_cases=10)
        use_cases = gen.generate(sample_extracted_requirements, schema_analysis=analysis)
...
class TestUseCaseTypeInference:
    ...
    def test_map_algorithm_to_type(self):
        ...
        assert gen._map_algorithm_to_type("community_detection") == UseCaseType.COMMUNITY
...
class TestUseCaseContent:
    ...
    def test_use_case_includes_data_needs(self, sample_extracted_requirements, sample_graph_schema):
