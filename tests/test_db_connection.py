...
class TestGetDBConnection:
    ...
    @patch('graph_analytics_ai.db_connection.get_arango_config')
    def test_successful_connection(self, mock_get_config, mock_client_class, mock_env_amp):
    ...
    @patch('graph_analytics_ai.db_connection.ArangoClient')
    @patch('graph_analytics_ai.db_connection.get_arango_config')
    def test_database_not_exists(self, mock_get_config, mock_client_class, mock_env_amp):
    ...
    def test_password_masked_in_error(self, mock_get_config, mock_env_amp):
        ...
        with patch('graph_analytics_ai.db_connection.ArangoClient') as mock_client_class:
            mock_client = MagicMock()
            mock_sys_db = MagicMock()
            mock_sys_db.version.side_effect = Exception("Password secretpassword failed")
            mock_client.db.return_value = mock_sys_db
            mock_client_class.return_value = mock_client
